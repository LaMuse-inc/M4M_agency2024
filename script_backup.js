...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            submitBtn.style.background = 'linear-gradient(135deg, #00d084 0%, #00a046 100%)';
    ...
    // デバッグ用コンソールメッセージ
    // ==========================================
    console.log('%c M4M AGENCY ', 'background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; font-size: 20px; padding: 10px;');
